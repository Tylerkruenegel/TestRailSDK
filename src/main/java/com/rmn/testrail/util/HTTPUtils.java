...
public class HTTPUtils implements Serializable {
    ...
    /**
     * Prepare everything about a GET request, including adding the headers, composing the URL, establishing the
     * Connection
     *
     ...
     */
    public HttpURLConnection getHTTPRequest(String completeUrl, String authentication, Map<String, String> headers)
            throws IOException {
     ...
     */
    private HttpURLConnection submitRequestFromConnectionWithRetry(HttpURLConnection connection, int retries)
            throws IOException {
    ...
    /**
     * Generate the string you'd need to use to re-create this API call. We're not using Curl--this just helps you debug
    ...
    public String getCurlCommandStringGet(String completeUrl, Map<String, String> headers) {
        String curlStr =
                "curl -v "; //The default is "verbose", but you can remove this if you don't care about the headers
     ...
     * @return A String representing the exact curl command needed to reproduce this call outside of this method
     */
    public String getCurlCommandStringPost(String completeUrl, Map<String, String> headers,
    ...
    public String encodeAuthenticationBase64(String username, String password) {
        ...
        return Base64.encodeToString(credentials.getBytes(), Base64.DEFAULT).replace("/n", "");
    }
}
